...
public class AddAuthorTest {
    ...
    public void caseSensitivityTest() throws Exception {
        Terminal.addSingleLineOutputThatIsExactly("add author Alan,Turing", "Ok");
        Terminal.addSingleLineOutputThatIsExactly("add author Alan,turing", "Ok");
        Terminal.addSingleLineOutputThatIsExactly("add author alan,Turing", "Ok");
    ...
    @Test
    public void inavlidTest3() throws Exception {
        Terminal.addSingleLineOutputThatMatches("add author David,Oberacker0", Matchers.startsWith("Error, "));
        Terminal.addSingleLineOutputThatMatches("add author David", Matchers.startsWith("Error, "));
        Terminal.addSingleLineOutputThatMatches("add author David:Oberacker", Matchers.startsWith("Error, "));
        Terminal.addSingleLineOutputThatMatches("add author David.Oberacker", Matchers.startsWith("Error, "));
        Terminal.addSingleLineOutputThatMatches("add author David--Oberacker", Matchers.startsWith("Error, "));
